...
Ролевое управление доступом позволяет гибко, динамически изменяться во время работы систем контроля доступа.
...
Если вам нужно было бы управлять пользователями напрямую, назначив им разрешения,
...
Пример добавления собственных разрешений с использованием провайдера:
